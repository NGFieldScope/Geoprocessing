    ...
    public class UpstreamArea : GPPage
    {
        ...
        protected void Page_Load (object sender, EventArgs evt) {
            try {
                ...
                string flowAccumDS = ConfigurationManager.AppSettings["FlowAccumulation"];
                ...
                string threshold = ConfigurationManager.AppSettings["HighResolutionAccumThreshold"];
                if (threshold != null) {
                ...
                string flowAreaDS = ConfigurationManager.AppSettings["FlowArea"];
                IRasterDataset flowArea = rasterWorkspace.OpenRasterDataset(flowAreaDS);

                string flowLineDS = ConfigurationManager.AppSettings["FlowLine"];
